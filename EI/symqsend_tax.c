...
typedef struct mqnsend_tax_ctx_s  mqnsend_tax_ctx_t;
struct mqnsend_tax_ctx_s {
    exmqparm_t      exmqparm;
    mq_info_t       mqinfo;
...
int                 mqnsend_tax(commbuff_t    *commbuff);
...
static int          b100_mqparm_load(mqnsend_tax_ctx_t    *ctx);
static int          d100_init_mqcon(mqnsend_tax_ctx_t     *ctx);
static int          e100_get_sendmsg(mqnsend_tax_ctx_t    *ctx);
static int          f100_put_mqmsg(mqnsend_tax_ctx_t      *ctx);
static int          g100_update_proc_code(mqnsend_tax_ctx_t   *ctx);
...
int apsvrinit(int argc, char argv[])
{
    ...
    int                 rc = ERR_NONE;
    //mqnsend_tax_ctx_t _ctx = {0};
    //mqnsend_tax_ctx_t *ctx = &_ctx;
